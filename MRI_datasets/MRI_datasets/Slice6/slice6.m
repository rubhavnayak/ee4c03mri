...
badCh1 = load('BadData/slice6_channel1.mat', 'slice6_channel1_badData').slice6_channel1_badData;
badCh2 = load('BadData/slice6_channel2.mat', 'slice6_channel2_badData').slice6_channel2_badData;
badCh3 = load('BadData/slice6_channel3.mat', 'slice6_channel3_badData').slice6_channel3_badData;

goodCh1 = load('GoodData/slice6_channel1.mat', 'slice6_channel1_goodData').slice6_channel1_goodData;
goodCh2 = load('GoodData/slice6_channel2.mat', 'slice6_channel2_goodData').slice6_channel2_goodData;
goodCh3 = load('GoodData/slice6_channel3.mat', 'slice6_channel3_goodData').slice6_channel3_goodData;
