...
badCh1 = load('BadData/slice4_channel1.mat', 'slice4_channel1_badData').slice4_channel1_badData;
badCh2 = load('BadData/slice4_channel2.mat', 'slice4_channel2_badData').slice4_channel2_badData;
badCh3 = load('BadData/slice4_channel3.mat', 'slice4_channel3_badData').slice4_channel3_badData;

goodCh1 = load('GoodData/slice4_channel1.mat', 'slice4_channel1_goodData').slice4_channel1_goodData;
goodCh2 = load('GoodData/slice4_channel2.mat', 'slice4_channel2_goodData').slice4_channel2_goodData;
goodCh3 = load('GoodData/slice4_channel3.mat', 'slice4_channel3_goodData').slice4_channel3_goodData;
