...
badCh1 = load('BadData/slice5_channel1.mat', 'slice5_channel1_badData').slice5_channel1_badData;
badCh2 = load('BadData/slice5_channel2.mat', 'slice5_channel2_badData').slice5_channel2_badData;
badCh3 = load('BadData/slice5_channel3.mat', 'slice5_channel3_badData').slice5_channel3_badData;

goodCh1 = load('GoodData/slice5_channel1.mat', 'slice5_channel1_goodData').slice5_channel1_goodData;
goodCh2 = load('GoodData/slice5_channel2.mat', 'slice5_channel2_goodData').slice5_channel2_goodData;
goodCh3 = load('GoodData/slice5_channel3.mat', 'slice5_channel3_goodData').slice5_channel3_goodData;
