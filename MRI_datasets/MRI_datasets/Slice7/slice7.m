...
badCh1 = load('BadData/slice7_channel1.mat', 'slice7_channel1_badData').slice7_channel1_badData;
badCh2 = load('BadData/slice7_channel2.mat', 'slice7_channel2_badData').slice7_channel2_badData;
badCh3 = load('BadData/slice7_channel3.mat', 'slice7_channel3_badData').slice7_channel3_badData;

goodCh1 = load('GoodData/slice7_channel1.mat', 'slice7_channel1_goodData').slice7_channel1_goodData;
goodCh2 = load('GoodData/slice7_channel2.mat', 'slice7_channel2_goodData').slice7_channel2_goodData;
goodCh3 = load('GoodData/slice7_channel3.mat', 'slice7_channel3_goodData').slice7_channel3_goodData;
