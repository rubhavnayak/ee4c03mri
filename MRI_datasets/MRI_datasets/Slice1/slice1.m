...
badCh1 = load('BadData/slice1_channel1.mat', 'slice1_channel1_badData').slice1_channel1_badData;
badCh2 = load('BadData/slice1_channel2.mat', 'slice1_channel2_badData').slice1_channel2_badData;
badCh3 = load('BadData/slice1_channel3.mat', 'slice1_channel3_badData').slice1_channel3_badData;

goodCh1 = load('GoodData/slice1_channel1.mat', 'slice1_channel1_goodData').slice1_channel1_goodData;
goodCh2 = load('GoodData/slice1_channel2.mat', 'slice1_channel2_goodData').slice1_channel2_goodData;
goodCh3 = load('GoodData/slice1_channel3.mat', 'slice1_channel3_goodData').slice1_channel3_goodData;
