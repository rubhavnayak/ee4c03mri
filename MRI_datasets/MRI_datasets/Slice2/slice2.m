...
badCh1 = load('BadData/slice2_channel1.mat', 'slice2_channel1_badData').slice2_channel1_badData;
badCh2 = load('BadData/slice2_channel2.mat', 'slice2_channel2_badData').slice2_channel2_badData;
badCh3 = load('BadData/slice2_channel3.mat', 'slice2_channel3_badData').slice2_channel3_badData;

goodCh1 = load('GoodData/slice2_channel1.mat', 'slice2_channel1_goodData').slice2_channel1_goodData;
goodCh2 = load('GoodData/slice2_channel2.mat', 'slice2_channel2_goodData').slice2_channel2_goodData;
goodCh3 = load('GoodData/slice2_channel3.mat', 'slice2_channel3_goodData').slice2_channel3_goodData;
