...
badCh1 = load('BadData/slice3_channel1.mat', 'slice3_channel1_badData').slice3_channel1_badData;
badCh2 = load('BadData/slice3_channel2.mat', 'slice3_channel2_badData').slice3_channel2_badData;
badCh3 = load('BadData/slice3_channel3.mat', 'slice3_channel3_badData').slice3_channel3_badData;

goodCh1 = load('GoodData/slice3_channel1.mat', 'slice3_channel1_goodData').slice3_channel1_goodData;
goodCh2 = load('GoodData/slice3_channel2.mat', 'slice3_channel2_goodData').slice3_channel2_goodData;
goodCh3 = load('GoodData/slice3_channel3.mat', 'slice3_channel3_goodData').slice3_channel3_goodData;
